          ...
          <?php include(ROOT_PATH . "/app/helpers/formErrors.php"); ?>
                ...
                <form action="create.php" method="post">
                    ...
                    <div class="form-outline mb-4">
                        ...
                        <label class="form-label" for="form3Example1cg" name="username">Name</label>
                      </div>
                    ...
                    <div>
                    <button class="btn btn-outline-light btn-lg px-5" name="add-admin" id="addTopic" type="submit">Add user</button>
                  </div>
