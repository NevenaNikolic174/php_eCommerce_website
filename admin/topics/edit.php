          ...
          <div class="row d-flex justify-content-center align-items-center h-100">
            ...
            <?php include(ROOT_PATH . "/app/helpers/formErrors.php"); ?>
                ...
                <div class="form-outline mb-4">
                        <input type="hidden" id="form3Example1cg" class="form-control form-control-lg" name="id" value="<?php echo $id; ?>"/>
                      </div>

                    <div class="form-outline mb-4">
                        <input type="text" id="form3Example1cg" class="form-control form-control-lg" name="name" value="<?php echo $name; ?>"/>
                    ...
                    <button class="btn btn-outline-light btn-lg px-5" id="addTopic" name="update-topic" type="submit">Update topic</button>
                  </div>
